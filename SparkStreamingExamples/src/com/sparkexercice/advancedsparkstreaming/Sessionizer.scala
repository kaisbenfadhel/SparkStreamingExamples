...
package com.sparkexercice.advancedsparkstreaming
...
import com.sparkexercice.sparkstreaming.Utilities._
...
object Sessionizer {
  ...
  def main(args: Array[String]) {
    ...
    stateSnapshotStream.foreachRDD((rdd, time) => {
      ...
      val requestsDataFrame = rdd.map(x => (x._1, x._2.sessionLength, x._2.clickstream)).toDF("ip", "sessionLength", "clickstream","totalSuccess","totalError")
